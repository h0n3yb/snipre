...
class RealtorScraper(Scraper):
    ...
    def handle_listing(self, listing_id: str) -> list[Property]:
        ...
        listing = Property(
            ...
            home_insurance=prop_details.get("home_insurance"),
            property_tax=prop_details.get("property_tax"),
        )
    ...
    def get_prop_details(self, property_id: str) -> dict:
        ...
        monthly_payment_details = get_key(["data", "home", "mortgage", "estimate", "monthly_payment_details"])

        home_insurance = None
        property_tax = None

        for detail in monthly_payment_details:
            if detail.get("type") == "home_insurance":
                home_insurance = detail.get("amount")
            elif detail.get("type") == "property_tax":
                property_tax = detail.get("amount")
        ...
        return {
            ...
            "home_insurance": home_insurance if home_insurance else None,
